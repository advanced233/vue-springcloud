    ...
    <el-card class="form-wrapper" shadow="hover">
      ...
      <el-form @submit.prevent="handleRegister" label-position="top">
        <el-form-item label="用户名">
          <el-input v-model="admin.username" placeholder="请输入用户名" clearable />
        </el-form-item>
        <el-form-item label="密码">
          <el-input v-model="admin.password" type="password" placeholder="请输入密码" clearable show-password />
        </el-form-item>
        <el-form-item label="手机号码">
          <el-input v-model="admin.phone" type="tel" placeholder="请输入手机号码" clearable />
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    async handleRegister() {
      try {
        const response = await registerAdmin(this.admin);
